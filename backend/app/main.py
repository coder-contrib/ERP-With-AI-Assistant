...
from app.routers import auth, products, categories, customers, suppliers, sales, purchases, inventory, payments, expenses, users, transfers, dashboard, tasks, ai

app = FastAPI(
    title="Ceramic Showroom ERP API",
    version="3.1.0",
    description="Event-driven ERP system with AI assistant",
)
...
@app.get("/")
def root():
    return {"message": "Ceramic Showroom ERP API", "version": "3.1.0"}
